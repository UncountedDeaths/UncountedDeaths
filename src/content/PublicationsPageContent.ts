...
export const content: ContentCardProps[] = [
  ...
  },
  {
    ...
    author:'Chen YH, Stokes AC, Aschmann HE, Chen R, DeVost S, Kiang MV, Koliwad S, Riley AR, Glymour MM, Bibbins-Domingo K',
    date: 'July, 2022',
  ...
  },
  {
    ...
    author: 'Bor J, Stokes AC, Raifman J, Venkataramani A, Bassett MT, Himmelstein D, Woolhandler S',
    date: 'June, 2022',
    ...
    {
    title:'“Pandemic of the unvaccinated”? At midlife, white people are less vaccinated but still at less risk of Covid-19 mortality in Minnesota.',
  ...
  {
    title:'Excess all-cause mortality across counties in the United States, March 2020 to December 2021',
    author:'Paglino E, Lundberg DJ, Cho A, Wasserman JA, Raquib R, Luck AN, Hempstead K, Bor J, Elo IT, Preston SH, Stokes AC',
    date: 'May, 2022',
  ...
  {
    title:'Evaluation of Age Patterns of COVID-19 Mortality by Race and Ethnicity From March 2020 to October 2021 in the US',
  ...
  {
    title:'COVID-19 mortality among working-age Americans in 46 states, by industry and occupation',
    author: 'Chen YH, Chen R, Charpignon ML, Kiang MV, Riley AR, Glymour MM, Bibbins-Domingo K, Stokes AC',
    date: 'April, 2022',
  ...
  {
    title:'COVID-19 mortality and excess mortality among working-age Californians, by occupational sector: March 2020 through November 2021',
    author:'Chen YH, Riley AR, Duchowny KA, Aschmann HE, Chen R, Kiang MV, Mooney A, Stokes AC, Glymour MM, Bibbins-Domingo K',
    date: 'February, 2022',
  ...
  {
    title:'Association of Health Care Factors With Excess Deaths Not Assigned to COVID-19 in the US',
  ...
  {
    title:'Excess Deaths During the COVID-19 Pandemic: Implications for US Death Investigation Systems',
